...
const CORPORATE_PHOTOS = [
  { src: '/marketing-placeholder/corporate-stage-thumb.jpg' },
  { src: '/marketing-placeholder/corporate-networking-thumb.jpg' },
  { src: '/marketing-placeholder/corporate-team-thumb.jpg' },
  { src: '/marketing-placeholder/corporate-celebration-thumb.jpg' },
  { src: '/marketing-placeholder/corporate-candid-thumb.jpg' },
  { src: '/marketing-placeholder/corporate-detail-thumb.jpg' },
]
...
export function CorporateLandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background font-body text-foreground">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
            <div className="min-w-0 text-center lg:text-left">
              <div className="animate-fade-up inline-flex items-center gap-1.5 rounded-full border border-border bg-secondary px-3 py-1">
                <Building2 className="h-3 w-3 text-accent-dark" aria-hidden="true" />
            ...
            <div className="animate-fade-up delay-200 relative flex min-w-0 justify-center lg:justify-end">
              <div className="relative w-full max-w-[320px] xl:origin-right xl:scale-110 2xl:scale-125">
                ...
                <PhoneMockup
                  ...
                  url="snaprooms.app/event/summit-2026"
                  photos={CORPORATE_PHOTOS}
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:items-center">
            ...
            <div className="reveal min-w-0 overflow-hidden rounded-2xl border border-border shadow-elevated" style={{ transitionDelay: '100ms' }}>
              <div className="relative aspect-[4/3]">
                <Image
                  src="/marketing-placeholder/corporate-networking-card.jpg"
                  alt=""
                  fill
                ...
                <div className="absolute inset-x-0 bottom-0 p-5">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/15 backdrop-blur-sm">
                    <Presentation className="h-5 w-5 text-white" aria-hidden="true" />
                  </div>
              ...
              <div className="relative mx-auto max-w-sm">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-border shadow-elevated">
                  <div className="relative aspect-square">
                    <Image src="/marketing-placeholder/corporate-detail-square.jpg" alt="" fill sizes="384px" className="object-cover" />
                    <div
                      className="absolute inset-0"
                      aria-hidden="true"
      ...
      {/* Cross-link — for the professionals running the event */}
            ...
            {[
              {
                ...
                icon: Users,
                title: tLanding.audiencePlannerQ,
                cta: nav.forPlanners,
              ...
              },
              {
                ...
                icon: Camera,
                title: tLanding.audiencePhotographerQ,
                cta: nav.forPhotographers,
              ...
              >
                ...
                <div className="relative p-5">
                  ...
                  {item.desc && <p className="mt-1 text-xs text-white/80 leading-relaxed line-clamp-2">{item.desc}</p>}
