  ...
  return (
    <div className="flex items-center gap-2">
      {authenticated ? (
        ...
        // Sign in is reachable on mobile via the footer's "Organizer sign in" link;
        // dropping the header copy here keeps the mobile nav row (logo, CTA, menu
        // trigger) from overflowing at narrow phone widths.
        <Button
          variant="ghost"
          size="sm"
          asChild
      ...
      <Button
        size="sm"
        asChild
        className="cta-primary flex-shrink-0 whitespace-nowrap rounded-lg font-semibold max-[359px]:px-2"
      >
