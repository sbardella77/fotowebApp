 ...
 *
 * Mirrors the premium rule of resolveSubscriptionAccessState in
 * lib/server/subscription-lifecycle.js: a scheduled cancellation keeps
 * premium active only until the current period end.
 */
export function isEffectivePremiumActive({
  ...
  if (isCancellationScheduled) {
    return isDateInFuture(subscriptionCurrentPeriodEnd)
  }
