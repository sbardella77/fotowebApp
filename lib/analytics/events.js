...
export const EVENT_PHOTOS_SELECTED = 'photos_selected'
...
export const EVENT_GUEST_UPLOAD_OPTIMIZED = 'guest_upload_optimized'
export const EVENT_UPLOAD_FAILED = 'upload_failed'
export const EVENT_MOMENT_SELECTED = 'moment_selected'
export const EVENT_GUEST_NAME_ENTERED = 'guest_name_entered'
...
export const EVENT_ORIGINAL_QUALITY_PAYWALL_VIEWED = 'original_quality_paywall_viewed'
export const EVENT_ORIGINAL_QUALITY_UNLOCK_CLICKED = 'original_quality_unlock_clicked'
...
// Extra Free Event “buy and create” flow
export const EXTRA_FREE_EVENT_CHECKOUT_CREATED = 'extra_free_event_checkout_created'
export const EXTRA_FREE_EVENT_AUTO_CREATE_SUCCESS = 'extra_free_event_auto_create_success'
export const EXTRA_FREE_EVENT_AUTO_CREATE_FAILED = 'extra_free_event_auto_create_failed'
