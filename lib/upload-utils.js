 ...
 * amplifies load against an already-exceeded bucket. Every other status
 * (5xx, other 4xx) stays retryable here; callers still classify specific
 * bodies (e.g. photo_count) as nonRetryable separately.
 * @param {number} status
 * @returns {boolean}
 */
