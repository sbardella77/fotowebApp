...
export const uploadInitSchema = z.object({
  ...
  // Intentionally untyped/unvalidated here: a malformed contributorId must
  // never fail this schema's .parse() and abort the whole upload. Real
  // format validation happens separately in normalizeContributorId(), whose
  // output (not this raw value) is what actually gets persisted.
  contributorId: z.unknown().optional(),
})
...
export const adminMetricsRangeSchema = z.enum(['7d', '30d', '90d', 'all'])
