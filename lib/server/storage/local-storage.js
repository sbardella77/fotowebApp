...
export const localStorageDriver = {
  ...
  async initUploadSession({ eventSlug, fileName, fileSize, mimeType, totalChunks, directory = 'events', contributorId = null, uploadActorType = null }) {
  ...
  async completeUploadSession({ sessionId, photoId }) {
    ...
    return {
      ...
      storageMode: 'local',
      // meta.contributorId is undefined for sessions created before this
      // field existed (legacy meta.json on disk) — normalize to null.
      contributorId: meta.contributorId || null,
      // Same legacy-session fallback as contributorId above.
      uploadActorType: meta.uploadActorType || null,
    }
  },
