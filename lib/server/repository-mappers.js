...
export const normalizePhotoRecord = (photo) => {
  ...
  // Server-side code that needs it (ensurePhotoDisplayDerivative) reads
  // the Prisma row directly, before normalization.
  const { uploadActorType, displayDerivativeStatus, ...publicPhoto } = photo
